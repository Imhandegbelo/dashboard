...
export default function Topnav() {
  return (
    <header className="flex items-center gap-6 py-[10px] px-5 border-b border-[#E5EAEF] text-[#26282C]">
      <div className="flex justify-between basis-3/5">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="bg-search bg-no-repeat bg-[center_left_1rem] border border-[#DADDDD] bg-white py-1 pl-10 w-[300px] placeholder:text-[#a3a3a3] rounded-full"
        />
      </div>
      <div className="basis-2/5 flex justify-between items-center font-Inter text-[#26282C]">
        ...
        <button className="flex justify-center items-center rounded-full border border-[#DADDDD] w-10 h-10">
          <img src={topnavIcons.bell} alt="" />
        </button>
        <div className="flex items-center gap-4 border border-[#DADDDD] p-2 rounded-full">
